...
- **정상 범위** (drain 20ms · k6 실측 2026-08-27, 로컬):
  ...
  | 유입 | p50 | p95 | p99 |
  |---|---|---|---|
  | 200 RPS | 21.3ms | 28.1ms | **32.3ms** |
  | 500 RPS | 22.3ms | 29.7ms | 30.8ms |
  | 1,000 RPS | 32.2ms | 45.9ms | 75.1ms |
  | 2,000 RPS | 41.4ms | 71.7ms | 103.6ms |

  🔴 **큐 40개 기준이다.** p99는 큐 수의 함수다 — 2,000 RPS에서 큐 10개 64.42ms · 20개 77.37ms ·
  43개 130.50ms다(`doc/perf/ENQUEUE_TUNING.md` ③, 이 표와 판이 달라 절대값을 섞지 마라). 판정 전에 **활성 큐 수부터 확인**해라.
